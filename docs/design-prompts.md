...
จุดประสงค์: เลือก **โทนสี + บรรยากาศ + องค์ประกอบ** ก่อนลงมือทำ UI จริง
...
2. วางในเครื่องมือสร้างภาพ · อัตราส่วนมือถือ **9:19.5** (หรือ 390×844)
   ...
   - ChatGPT / GPT image, Gemini: พิมพ์ prompt ได้ตรง ๆ · แนบภาพอ้างอิง (เช่น `docs/preview-light.png` ของโปรเจกต์เดิม) จะคุมโทนได้แม่นขึ้น
...
## §A — Teal & Calm (ปรับจากธีมเดิมของโปรเจกต์)
...
มู้ด: นิ่ง ไว้วางใจ อ่านง่าย · ข้อดี: เป็นธีมที่โปรเจกต์เดิมออกแบบและวัดคอนทราสต์ไว้แล้ว → ยกมาใช้ต่อได้ทันที
